    ...
    return (
        <PageBody>
            <Container style={{paddingTop:'1rem'}}>
                <h2>Welcome to Drift Island Magazine</h2>
                <p>These terms and conditions outline the rules and regulations for the use of Drift Island Magazine's
                    Website.</p> <br/>
                <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to
                    use Drift Island Magazine's website
                ...
                <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                    ...
                    prevailing law
                    of Puerto Rico. Any use of the above terminology or other words in the singular, plural,
                    capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to
                    same.</p><h2>Cookies</h2>
                <p>We employ the use of cookies. By using Drift Island Magazine's website you consent to the use of
                    cookies
                    in accordance with Drift Island Magazine's privacy policy.</p><p>Most of the modern day interactive
                web sites
                ...
                <p>Unless otherwise stated, Drift Island Magazine and/or it's licensors own the intellectual property
                    rights for
                    all material on Drift Island Magazine. All intellectual property rights are reserved. You may view
                    and/or print
                    pages from https://www.driftisland.org for your own personal use subject to restrictions set in
                    these terms and conditions.</p>
                <p>You must not:</p>
                <ol>
                    <li>Republish material from https://www.driftisland.org</li>
                    <li>Sell, rent or sub-license material from https://www.driftisland.org</li>
                    <li>Reproduce, duplicate or copy material from https://www.driftisland.org</li>
                </ol>
                <p>Redistribute content from Drift Island Magazine (unless content is specifically made for
                    redistribution).</p>
                <h2>User Comments</h2>
                <ol>
                    ...
                    <li>Certain parts of this website offer the opportunity for users to post and exchange opinions,
                        information,
                        material and data ('Comments') in areas of the website. Drift Island Magazine does not screen,
                        edit, publish
                    ...
                    <li>You hereby grant to <strong>Drift Island Magazine</strong> a non-exclusive royalty-free license
                        to use, reproduce,
                ...
                <p>We will approve link requests from these organizations if we determine that: (a) the link would not
                    ...
                    from
                    the visibility associated with the hyperlink outweighs the absence of Drift Island Magazine and (d)
                    where the
                ...
                <p>No use of Drift Island Magazine's logo or other artwork will be allowed for linking absent a
                    trademark license
                    agreement.</p>
                <h2>Iframes</h2>
